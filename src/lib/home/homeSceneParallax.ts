export const homeSceneDepths = {
  ...
  trainingParticlesFar: { translationX: 15, translationY: 1.2, rotation: 0, scale: 1 },
  trainingParticlesMid: { translationX: 27, translationY: 2, rotation: 0, scale: 1 },
  trainingParticlesNear: { translationX: 42, translationY: 3, rotation: 0, scale: 1 },
