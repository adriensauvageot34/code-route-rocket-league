...
assert(trainingGpuFennecTiming.includes("baseOpacity: 1 - impactOpacity") && trainingGpuFennecTiming.includes("FENNEC_TACTICAL_EMPHASIS_DURATION_MS = 650") && trainingGpuFennecTiming.includes("{ progress: 1, opacity: 0 }"), "The GPU Fennec base and tactical impact must use inverse validated curves that return to their neutral values.");
